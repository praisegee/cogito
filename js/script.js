...
function getData() {
  const data = {
    ...
    totalWith5PercentVat: function () {
      return (Number(this.eventCost) + Number(this.vatFor5Percent())).toFixed(
        2
      );
    },
    totalWith75PercentVat: function () {
      return (Number(this.eventCost) + Number(this.vatFor75Percent())).toFixed(
        2
      );
    },
    invoiceNo: function () {
...
function handleRequest(method, data) {
  const url =
    "https://api.sheety.co/2620d6b350ebd0c7460aef489947c6a6/2022ScheduleSalesInvoice/sheet1/";
													...
													<div class="invoice-content">
														<table>
															...
															<tr>
																<th>Event Date: </th>
																<td>${
                                  data.sheet1.eventDate == null ||
                                  data.sheet1.eventDate == ""
                                    ? "None"
                                    : data.sheet1.eventDate
                                }</td>
															</tr>
															...
															<tr>
																<th>First Payment: </th>
																<td>${
                                  data.sheet1.firstPayment == null ||
                                  data.sheet1.firstPayment == ""
                                    ? "None"
                                    : data.sheet1.firstPayment
                                }</td>
															</tr>
															<tr>
																...
																<td>${
                                  data.sheet1.secondPayment == null ||
                                  data.sheet1.secondPayment == ""
                                    ? "None"
                                    : data.sheet1.secondPayment
                                }</td>
															</tr>
